...
release: node_modules
	npx webpack bundle --mode production --output-filename $(output_dev)
	npx webpack bundle --mode production --env=minimize --output-filename $(output)
